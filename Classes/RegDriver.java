...
public class RegDriver extends AppCompatActivity {
    ...
    private DatabaseReference mappingReference;
    ...
    private void AddMappingOFIDs(){
        String uid=mAuth.getCurrentUser().getUid();
        mappingReference=FirebaseDatabase.getInstance().getReference().child("Mapping").child(uid);
        mappingReference.setValue(vehicle);
    }
    private void Register(String email,String password,String phonee,String Name,String ghs,String License){
        if (TextUtils.isEmpty(email)){
            Toast.makeText(RegDriver.this,"Please write email",Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(password)){
            Toast.makeText(RegDriver.this,"Please write password",Toast.LENGTH_SHORT).show();
        }

       else if (TextUtils.isEmpty(phonee)){
            Toast.makeText(RegDriver.this,"Please write phone number",Toast.LENGTH_SHORT).show();
        }
       else if (TextUtils.isEmpty(Name)){
            Toast.makeText(RegDriver.this,"Please write Name",Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(ghs)){
            Toast.makeText(RegDriver.this,"Please write GHS number",Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(License)){
            Toast.makeText(RegDriver.this,"Please write License number",Toast.LENGTH_SHORT).show();
        }
        else{
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if(task.isSuccessful()){
                        ...
                        if(firebaseUser != null) {
                            ...
                            IDEmail=FirebaseDatabase.getInstance().getReference().child("IDEmail").child(AddDriverID);
                        ...
                        Toast.makeText(RegDriver.this,"Driver Added",Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                        //

                       Intent intent=new Intent(RegDriver.this,DriverHome.class);
                        startActivity(intent);
                    }
                    else{
                        Toast.makeText(RegDriver.this,"Registration unsuccessful",Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
